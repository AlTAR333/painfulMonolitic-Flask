...
Each row has a delete button that triggers a confirmation dialog before deleting.
If accepted the data is permanently deleted from the database.
...
Submits to `POST /view/users`. The new user should appear immediately in the table.
